...
export class CalciteTreeItem {
  ...
  render() {
    ...
    const checkbox = this.inputEnabled ? (h("label", { class: "calcite-tree-label" },
      h("calcite-checkbox", { checked: this.selected, class: "calcite-tree-checkbox", "data-test-id": "checkbox", indeterminate: this.hasChildren && this.indeterminate, scale: this.scale, tabIndex: -1 }),
      h("slot", null))) : null;
