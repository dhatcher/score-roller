import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement } from './index-b3673963.js';
import { b as getSlotted, g as getElementDir } from './dom-7b4de04f.js';
...
const CalciteTipManager = class {
  ...
  render() {
    ...
    return (h("section", { "aria-hidden": closed.toString(), class: CSS$1.container, hidden: closed, onKeyUp: this.tipManagerKeyUpHandler, ref: this.storeContainerRef, tabIndex: 0 }, h("header", { class: CSS$1.header }, h(CalciteHeading, { class: CSS$1.heading, level: headingLevel || HEADING_LEVEL$1 }, groupTitle), h("calcite-action", { class: CSS$1.close, icon: ICONS$1.close, onClick: this.hideTipManager, text: closeLabel })), h("div", { class: {
