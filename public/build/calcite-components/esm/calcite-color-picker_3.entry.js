import { r as registerInstance, c as createEvent, h, g as getElement } from './index-b3673963.js';
import { f as focusElement, g as getElementDir, C as CSS_UTILITY, a as getThemeName } from './dom-7b4de04f.js';
import { n as normalizeHex, C as CSSColorMode, p as parseMode, c as colorEqual, i as isValidHex, a as isLonghandHex, r as rgbToHex, h as hexToRGB, b as hexChar } from './utils-60acc1d6.js';
import { g as getKey } from './key-ec82f942.js';
import { c as clamp } from './math-c8e7aa13.js';
import { d as debounce, i as isObject } from './debounce-047e09f4.js';
...
const CalciteColorPicker = class {
  constructor(hostRef) {
    ...
    this.renderChannelsTab = (channelMode) => {
      ...
      return (h("calcite-tab", { active: active, class: CSS$2.control, key: channelMode }, h("div", { class: CSS$2.channels }, channels.map((channel, index) => this.renderChannel(channel, index, channelLabels[index], channelAriaLabels[index])))));
    };
    this.renderChannel = (value, index, label, ariaLabel) => (h("calcite-input", { class: CSS$2.channel, "data-channel-index": index, label: ariaLabel, numberButtonType: "none", onCalciteInputChange: this.handleChannelChange, onCalciteInputInput: this.handleChannelInput, prefixText: label, scale: this.scale === "l" ? "m" : "s", type: "number", value: value === null || value === void 0 ? void 0 : value.toString() }));
    this.deleteColor = () => {
  ...
  render() {
    ...
    return (h("div", { class: CSS$2.container }, h("div", { class: CSS$2.colorFieldAndSliderWrap }, h("canvas", { class: {
      ...
      } }, intlHex), h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: CSS$2.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, scale: hexInputScale, value: selectedColorInHex }))), hideChannels ? null : (h("calcite-tabs", { class: {
        [CSS$2.colorModeContainer]: true,
        [CSS$2.splitSection]: true
      }, dir: elementDir, scale: hexInputScale }, h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (h("div", { class: { [CSS$2.savedColorsSection]: true, [CSS$2.section]: true } }, h("div", { class: CSS$2.header }, h("label", null, intlSaved), h("div", { class: CSS$2.savedColorsButtons }, h("calcite-button", { appearance: "transparent", class: CSS$2.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", label: intlDeleteColor, onClick: this.deleteColor, scale: hexInputScale }), h("calcite-button", { appearance: "transparent", class: CSS$2.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", label: intlSaveColor, onClick: this.saveColor, scale: hexInputScale }))), savedColors.length > 0 ? (h("div", { class: CSS$2.savedColors }, [
...
const CalciteColorPickerHexInput = class {
  ...
  render() {
    ...
    const elementDir = getElementDir(el);
    return (h("div", { class: CSS$1.container }, h("calcite-input", { class: CSS$1.input, dir: elementDir, label: intlHex, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, prefixText: "#", ref: this.storeInputRef, scale: this.scale, value: hexInputValue }), hexInputValue ? (h("calcite-color-picker-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: this.scale })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
export { CalciteColorPicker as calcite_color_picker, CalciteColorPickerHexInput as calcite_color_picker_hex_input, CalciteColorPickerSwatch as calcite_color_picker_swatch };
