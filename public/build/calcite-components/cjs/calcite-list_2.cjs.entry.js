...
const CalciteListItem = class {
  ...
  renderContentContainer() {
    ...
    return !nonInteractive ? (index.h("button", { class: { [CSS.contentContainer]: true, [CSS.contentContainerButton]: true }, disabled: disabled }, content)) : (index.h("div", { class: CSS.contentContainer }, content));
  }
  render() {
    return (index.h(index.Host, { role: "listitem" }, index.h("div", { class: CSS.container }, this.renderActionsStart(), this.renderContentContainer(), this.renderActionsEnd())));
  }
  get el() { return index.getElement(this); }
};
CalciteListItem.style = calciteListItemCss;

exports.calcite_list = CalciteList;
