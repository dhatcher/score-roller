...
const number = require('./number-77308374.js');
...
const CalciteInput = class {
  constructor(hostRef) {
    ...
    this.inputNumberKeyDownHandler = (event) => {
      ...
      if (event.key === decimalSeparator &&
        number.isValidDecimal(this.step === "any" ? 1 : this.step)) {
  ...
  connectedCallback() {
    var _a;
    this.form = dom.closestElementCrossShadowBoundary(this.el, "form");
  ...
  render() {
    ...
    const inputClearButton = (index.h("button", { class: CSS.clearButton, disabled: this.disabled, onClick: this.clearInputValue, tabIndex: this.disabled ? -1 : 0, type: "button" }, index.h("calcite-icon", { icon: "x", scale: "s" })));
    ...
    const numberButtonsHorizontalUp = (index.h("button", { class: {
      ...
      }, "data-adjustment": "up", disabled: this.disabled, onClick: this.numberButtonClickHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: "s" })));
    const numberButtonsHorizontalDown = (index.h("button", { class: {
        [CSS.numberButtonItem]: true,
        [CSS.buttonItemHorizontal]: isHorizontalNumberButton
      }, "data-adjustment": "down", disabled: this.disabled, onClick: this.numberButtonClickHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: "s" })));
