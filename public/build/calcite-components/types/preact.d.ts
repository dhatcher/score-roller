...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "calcite-input-date-picker": Omit<JSX.CalciteInputDatePicker, "onCalciteDatePickerChange" | "onCalciteDatePickerRangeChange" | "onCalciteInputDatePickerOpen" | "onCalciteInputDatePickerClose"> & JSXInternal.HTMLAttributes<HTMLCalciteInputDatePickerElement> & {
        "oncalciteDatePickerChange"?: (event: CustomEvent<any>) => void;
        "oncalciteDatePickerRangeChange"?: (event: CustomEvent<any>) => void;
