...
const CalciteChip = class {
  ...
  renderChipImage() {
    ...
    return hasChipImage ? (h("div", { class: "chip-image-container" }, h("slot", { name: "image" }))) : null;
  }
  render() {
    const dir = getElementDir(this.el);
    const iconEl = (h("calcite-icon", { class: "calcite-chip--icon", dir: dir, flipRtl: this.iconFlipRtl, icon: this.icon, scale: "s" }));
    const closeButton = (h("button", { "aria-describedby": this.guid, "aria-label": this.dismissLabel, class: CSS.close, onClick: this.closeClickHandler, ref: (el) => (this.closeButton = el) }, h("calcite-icon", { icon: "x", scale: "s" })));
