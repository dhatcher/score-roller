import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement, F as Fragment } from './index-b3673963.js';
import { g as getElementDir, C as CSS_UTILITY, b as getSlotted, f as focusElement } from './dom-7b4de04f.js';
import { S as SLOTS$3, C as CSS$3, I as ICONS$2 } from './resources-82817f70.js';
...
const CalciteAction = class {
  ...
  renderIconContainer() {
    ...
    return hasIconToDisplay ? (h("div", { "aria-hidden": "true", class: CSS$2.iconContainer, key: "icon-container" }, iconNode, slotContainerNode)) : null;
  }
  render() {
...
const queryActions = (el) => {
  return Array.from(el.querySelectorAll("calcite-action")).filter((action) => action.closest("calcite-action-menu") ? action.slot === SLOTS$3.trigger : true);
};
...
const CalciteActionBar = class {
  constructor(hostRef) {
    ...
    this.resize = (height) => {
      ...
      const groupCount = getSlotted(el, SLOTS$2.bottomActions) || !expandDisabled
  ...
  renderBottomActionGroup() {
    ...
    const tooltip = getSlotted(el, SLOTS$2.expandTooltip);
    ...
    return getSlotted(el, SLOTS$2.bottomActions) || expandToggleNode ? (h("calcite-action-group", { class: CSS$1.actionGroupBottom }, h("slot", { name: SLOTS$2.bottomActions }), h("slot", { name: SLOTS$2.expandTooltip }), expandToggleNode)) : null;
  }
  render() {
...
const CalciteActionGroup = class {
  ...
  renderTooltip() {
    const { el } = this;
    const hasTooltip = getSlotted(el, SLOTS$1.menuTooltip);
    return hasTooltip ? h("slot", { name: SLOTS$1.menuTooltip, slot: SLOTS$3.tooltip }) : null;
  }
  renderMenu() {
    const { el, expanded, intlMore, menuOpen } = this;
    const hasMenuItems = getSlotted(el, SLOTS$1.menuActions);
    return hasMenuItems ? (h("calcite-action-menu", { expanded: expanded, flipPlacements: ["left", "right"], label: intlMore || TEXT$1.more, onCalciteActionMenuOpenChange: this.setMenuOpen, open: menuOpen, placement: "leading-start" }, h("calcite-action", { icon: ICONS.menu, slot: SLOTS$3.trigger, text: intlMore || TEXT$1.more, textEnabled: expanded }), h("slot", { name: SLOTS$1.menuActions }), this.renderTooltip())) : null;
  }
  render() {
...
const CalciteActionMenu = class {
  constructor(hostRef) {
    ...
    this.connectMenuButtonEl = () => {
      ...
      const menuButtonEl = getSlotted(el, SLOTS$3.trigger) || this.defaultMenuButtonEl;
    ...
    this.setTooltipReferenceElement = () => {
      ...
      const slotted = getSlotted(el, SLOTS$3.tooltip);
  ...
  renderMenuButton() {
    const { el, label } = this;
    const menuButtonSlot = (h("slot", { name: SLOTS$3.trigger }, h("calcite-action", { class: CSS$3.defaultTrigger, icon: ICONS$2.menu, ref: this.setDefaultMenuButtonEl, text: label })));
    return getSlotted(el, SLOTS$3.tooltip) ? (h("calcite-tooltip-manager", null, menuButtonSlot)) : (menuButtonSlot);
  }
  renderMenuItems() {
    ...
    return (h("calcite-popover", { disablePointer: true, label: label, offsetDistance: 0, open: open, overlayPositioning: overlayPositioning, placement: placement, referenceElement: menuButtonEl }, h("div", { "aria-activedescendant": activeDescendantId, "aria-labelledby": menuButtonEl === null || menuButtonEl === void 0 ? void 0 : menuButtonEl.id, class: CSS$3.menu, id: menuId, onClick: this.handleCalciteActionClick, onKeyDown: this.menuActionsContainerKeyDown, onKeyUp: this.menuActionsContainerKeyUp, ref: (el) => (this.menuEl = el), role: "menu", tabIndex: -1 }, h("slot", null))));
  }
  render() {
    return (h(Fragment, null, this.renderMenuButton(), this.renderMenuItems(), h("slot", { name: SLOTS$3.tooltip })));
  }
  getAssignedElements() {
...
const CalciteActionPad = class {
  ...
  renderBottomActionGroup() {
    ...
    const expandToggleNode = !expandDisabled ? (h(CalciteExpandToggle, { el: el, expanded: expanded, intlCollapse: collapseLabel, intlExpand: expandLabel, position: position, ref: this.setExpandToggleRef, toggle: toggleExpand, tooltip: tooltip })) : null;
    return expandToggleNode ? (h("calcite-action-group", { class: CSS.actionGroupBottom }, h("slot", { name: SLOTS.expandTooltip }), expandToggleNode)) : null;
  }
  render() {
...
export { CalciteAction as calcite_action, CalciteActionBar as calcite_action_bar, CalciteActionGroup as calcite_action_group, CalciteActionMenu as calcite_action_menu, CalciteActionPad as calcite_action_pad };
