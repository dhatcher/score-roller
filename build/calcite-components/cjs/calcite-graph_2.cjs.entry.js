...
const CalciteSlider = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { id: id, onTouchStart: this.handleTouchStart }, index.h("div", { class: { container: true, "container--range": this.isRange } }, this.renderGraph(), index.h("div", { class: "track" }, index.h("div", { class: "track__range", onPointerDown: () => this.dragStart("minMaxValue"), style: {
  ...
  renderGraph() {
    return this.histogram ? (index.h("div", { class: "graph" }, index.h("calcite-graph", { colorStops: this.histogramStops, data: this.histogram, height: 48, highlightMax: this.isRange ? this.maxValue : this.value, highlightMin: this.isRange ? this.minValue : this.min, width: 300 }))) : null;
  }
  ...
  //--------------------------------------------------------------------------
  handleLabelFocus(e) {
    if (e.detail.interactedEl !== this.el && dom.hasLabel(e.detail.labelEl, this.el)) {
      this.setFocus();
    }
  }
