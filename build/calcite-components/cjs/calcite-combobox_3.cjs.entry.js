...
const CalciteCombobox = class {
  ...
  renderInput() {
    ...
    return (index.h("span", { class: {
      ...
      }, key: "label", onFocus: this.comboboxFocusHandler, tabindex: "0" }, selectedItem.textLabel)), index.h("input", { "aria-activedescendant": this.activeDescendant, "aria-autocomplete": "list", "aria-controls": guid.guid, "aria-label": label, class: {
        input: true,
  ...
  renderIconEnd() {
    return (this.selectionMode === "single" && (index.h("span", { class: "icon-end" }, index.h("calcite-icon", { icon: "chevron-down", scale: "s" }))));
  }
  render() {
