...
const utils = require('./utils-d549a0a9.js');
const key = require('./key-f470de4c.js');
const math = require('./math-750406eb.js');
...
const CalciteColorPicker = class {
  constructor(hostRef) {
    ...
    this.handleColorFieldScopeKeyDown = (event) => {
      ...
      if (arrowKeyToXYOffset[key$1]) {
        event.preventDefault();
        this.scopeOrientation = key$1 === "ArrowDown" || key$1 === "ArrowUp" ? "vertical" : "horizontal";
        this.captureColorFieldColor(this.colorFieldScopeLeft + arrowKeyToXYOffset[key$1].x || 0, this.colorFieldScopeTop + arrowKeyToXYOffset[key$1].y || 0, false);
      }
    };
    ...
    this.renderChannelsTab = (channelMode) => {
      ...
      return (index.h("calcite-tab", { active: active, class: CSS$2.control, key: channelMode }, index.h("div", { class: CSS$2.channels }, channels.map((channel, index) => this.renderChannel(channel, index, channelLabels[index], channelAriaLabels[index])))));
    };
    this.renderChannel = (value, index$1, label, ariaLabel) => (index.h("calcite-input", { class: CSS$2.channel, "data-channel-index": index$1, label: ariaLabel, numberButtonType: "none", onCalciteInputChange: this.handleChannelChange, onCalciteInputInput: this.handleChannelInput, prefixText: label, scale: this.scale === "l" ? "m" : "s", type: "number", value: value === null || value === void 0 ? void 0 : value.toString() }));
    this.deleteColor = () => {
  ...
  handleChannelKeyUpOrDown(event) {
    this.shiftKeyChannelAdjustment = 0;
    const key$1 = key.getKey(event.key);
    if ((key$1 !== "ArrowUp" && key$1 !== "ArrowDown") ||
  ...
  render() {
    ...
    return (index.h("div", { class: CSS$2.container }, index.h("div", { class: CSS$2.colorFieldAndSliderWrap }, index.h("canvas", { class: {
        ...
        [CSS$2.section]: true,
        [dom.CSS_UTILITY.rtl]: elementDir === "rtl"
      } }, hideHex ? null : (index.h("div", { class: CSS$2.hexOptions }, index.h("span", { class: {
        [CSS$2.header]: true,
        [CSS$2.headerHex]: true
      } }, intlHex), index.h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: CSS$2.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, scale: hexInputScale, value: selectedColorInHex }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
        [CSS$2.colorModeContainer]: true,
        [CSS$2.splitSection]: true
      }, dir: elementDir, scale: hexInputScale }, index.h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (index.h("div", { class: { [CSS$2.savedColorsSection]: true, [CSS$2.section]: true } }, index.h("div", { class: CSS$2.header }, index.h("label", null, intlSaved), index.h("div", { class: CSS$2.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", class: CSS$2.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", label: intlDeleteColor, onClick: this.deleteColor, scale: hexInputScale }), index.h("calcite-button", { appearance: "transparent", class: CSS$2.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", label: intlSaveColor, onClick: this.saveColor, scale: hexInputScale }))), savedColors.length > 0 ? (index.h("div", { class: CSS$2.savedColors }, [
...
const CalciteColorPickerHexInput = class {
  ...
  render() {
    ...
    const elementDir = dom.getElementDir(el);
    return (index.h("div", { class: CSS$1.container }, index.h("calcite-input", { class: CSS$1.input, dir: elementDir, label: intlHex, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, prefixText: "#", ref: this.storeInputRef, scale: this.scale, value: hexInputValue }), hexInputValue ? (index.h("calcite-color-picker-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: this.scale })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
